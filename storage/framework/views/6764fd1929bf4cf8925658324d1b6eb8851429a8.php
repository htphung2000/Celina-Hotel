        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="dropdown py-2">
                <a href="#" class="dropdown-toggle text-center mr-5" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    <img src="<?php echo e(Session::get('Customer_Avatar')); ?>" class="img logo rounded-circle" height="35px" width="35px"> &nbsp;
                    <span class="Username"><?php echo e(Session::get('Customer_Name')); ?> </span>
                </a>
...
</header><?php /**PATH D:\xampp\htdocs\Celina\resources\views/header.blade.php ENDPATH**/ ?>