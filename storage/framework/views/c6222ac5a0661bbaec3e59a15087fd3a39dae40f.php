...
<body>
    ...
    <div class="wrapper d-flex align-items-stretch">
        <nav id="sidebar" style="background: #000" >
            <div class="p-3 pt-5">
                <a href="#" class="img logo rounded-circle img-thumbnail mb-4" style="background-image: url('<?php echo e(Session::get('Avatar')); ?>');"></a>
                ...
                <ul class="navbar-nav ml-auto mt-2">
                    <li class="dropdown border border-white py-1 px-3" style="border-radius: 30px; background: linear-gradient(to right, #00BFFF, #000)">
                        <a href="#" class="dropdown-toggle text-center" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            <img src="<?php echo e(Session::get('Avatar')); ?>" class="img logo rounded-circle" height="35px" width="35px"> &nbsp;
                            <span class="Username"><?php echo e(Session::get('Name')); ?> </span>
                        </a>
                        <ul class="dropdown-menu mx-2 p-2" style="background: #000">
                            <li><a href="/admin/employee/<?php echo e(Session::get('id')); ?>" class="px-2"><i class="fas fa-suitcase"></i>&nbsp; Trang cá nhân</a></li>
...
</html><?php /**PATH D:\xampp\htdocs\Celina\resources\views/admin/layout.blade.php ENDPATH**/ ?>